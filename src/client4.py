...
# Definisco il client
client_ip = "001.005.010.015"
client_mac = "42:A3:1B:DA:12:AC"
router_mac = "32:03:0A:DA:11:DC" # Il client conosce il mac del router in quanto si trovano sullo stesso nodo
server_ip = "195.001.010.010"

router = ("localhost", 9100)
# Apro una porta sul client
client = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
client.bind(("localhost", 1400))
...
finestra.title("Client 4 - %s" % client_ip)  # Al posto del nome dell'applicativo imposto il clientIP per facilitare l'utilizzo
