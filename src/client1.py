...
finestra.title("Client 1 - %s" % client_ip)  # Al posto del nome dell'applicativo imposto il clientIP per facilitare l'utilizzo
...
msg_list.pack()
messages_frame.pack()
msg_list.insert(tkt.END, "Welcome! Set your nickname to join the chat!") # Indico all'utente come comportarsi non appena avvia l'applicativo
